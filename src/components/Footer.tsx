...
const Footer: React.FC<FooterProps> = ({ selectedTab, setSelectedTab }: FooterProps) => {
    ...
    return (
        <footer className="grid grid-cols-5 bg-primary-gray h-header text-xl font-semibold font-display w-full sticky bottom-0 z-50">
            ...
            <div className={`self-center text-center `} onClick={() => setSelectedTab(TABS.EXPLORE)}>
            ...
            <div className={`self-center text-center`} onClick={() => setSelectedTab(TABS.CREATE)}>
            ...
            <div className={`self-center text-center`} onClick={() => setSelectedTab(TABS.NOTIFICATIONS)}>
            ...
            <div className={`self-center text-center`} onClick={() => setSelectedTab(TABS.PROFILE)}>
